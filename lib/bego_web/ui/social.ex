defmodule BegoWeb.UI.Social do
  use Phoenix.Component

  def twitter(assigns) do
    ~H"""
    <a href="https://twitter.com/begedinnikola">
      <svg
        class="w-2 h-2 text-blue-300 fill-current"
  ...
  def linkedin(assigns) do
    ~H"""
    <a href="https://www.linkedin.com/in/nikola-begedin-54541036/">
      <svg
  ...
  def email(assigns) do
    ~H"""
    <a href="mailto:begedinnikola+bego.dev@gmail.com">
      <svg
        xmlns="http://www.w3.org/2000/svg"
